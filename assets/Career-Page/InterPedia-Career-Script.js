...
<div class="modal-content">
  ...
  <div class="application-message">
    ...
    <p>We are currently reviewing applications. Please send your resume to <strong>hr@internpedia.in</strong> with the position title in the subject line.</p>
...
`;
    ...
    const g2 = new IntersectionObserver((a) => {
      a.forEach((a) => {
        if (a.isIntersecting) {
