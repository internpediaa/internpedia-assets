// DOM Elements
        ...
        function addCopyEventListeners() {
            ...
            document.querySelectorAll('.color-cellT').forEach(cell => {
                cell.addEventListener('click', function() {
                    copyToClipboard(this.getAttribute('data-value'), 'Color code');
                });
            });
            ...
            document.querySelectorAll('.hex-code-cellT').forEach(cell => {
                cell.addEventListener('click', function() {
                    copyToClipboard(this.getAttribute('data-value'), 'Hex code');
                });
            });
            ...
            document.querySelectorAll('.decimal-code-cellT').forEach(cell => {
                cell.addEventListener('click', function() {
                    copyToClipboard(this.getAttribute('data-value'), 'RGB code');
                });
            });
        }
